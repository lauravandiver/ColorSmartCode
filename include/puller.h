...
#define PU_MAX_V 10000     // Motor max speed
#define PU_MIN_V 100       // Motor min speed
#define PU_DEF_V 1500      // Motor default speed
#define PU_ACCEL 200000    // Motor Acceleration

// Define Driver with software SPI
TMC2130Stepper puller(PU_CS_PIN, PULL_R_SENSE, PU_SW_MOSI, PU_SW_MISO,
                      PU_SW_SCK); // Software SPI
...
void pullerStop(void) { as_puller.stop(); } // pullerStop
