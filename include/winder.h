...
TMC2130Stepper winder(W_CS_PIN, WIND_R_SENSE, W_SW_MOSI, W_SW_MISO, W_SW_SCK); // Software SPI
...
uint16_t winderRunSpeed(uint16_t w_speed){
  ...
  if((w_speed < W_MIN_V) || (w_speed > W_MAX_V)){ w_speed = W_DEF_V; }
