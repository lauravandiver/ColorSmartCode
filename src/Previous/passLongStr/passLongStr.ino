...
String run_shredder = "";    // Shredder control (off = 0, on foward = 1, on reverse = 2)
String set_temperature = ""; // Desired set point temperature (C) (three numbers)
...
// RECEIVE DATA
  ...
  if (run_shredder == "0"){
    ...
    Serial.println("shredder is confused"); // make this a command to turn off shredder
  }
...
// PACKAGE AND SEND
  messageOut = loadcell1 + loadcell2 + loadcell3 + loadcell4 + loadcell5 + loadcell6 + temp1 + temp2 + temp3 + "\n";
